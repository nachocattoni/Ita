...
\author{Gonzalo Turconi, Nacho Cattoni, Redigonda Maximiliano}
\date{Enero 8, 2018}
...
Las variables son cadenas alfanuméricas que comienzan con una letra en minúscula, y son seguidas obligatoriamente por un entero de etiqueta\footnote{Número entero no negativo representable por un entero con signo de 32 bits. Cualquier entero entre $0$ y $2^{31}-1$ inclusive.}. De esta manera:
\begin{itemize}
...
\noindent Es importante notar que una expresión, está definida como una variable, o un operador seguido de dos variables.
...
\item{Interpretar cada linea y discriminarlas por tipo de operación.}
...
\item{Programar el algoritmo del campesino ruso y realizarle pruebas para verificar su correctitud.}
\end{enumerate}
